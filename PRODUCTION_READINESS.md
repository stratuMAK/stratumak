...
- **Webapps (6 Vue3/TS apps, zero automated tests) — risk-split, not line-by-line.**
  ...
  lints the five non-deferred apps green via `make webapp-lint`. The
