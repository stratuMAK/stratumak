...
// #include "blendmath.h"
//
// extern const double gomc_tp_angle_epsilon;
// extern const double gomc_tp_angle_epsilon_sq;
import "C"
...
var (
	AngleEpsilon   = float64(C.gomc_tp_angle_epsilon)
	AngleEpsilonSq = float64(C.gomc_tp_angle_epsilon_sq)
)
