...
// l3FakeModule is a no-op gomc.Module for the load/unload race test.
...
func init() {
	...
	gomc.RegisterModule(l3RaceModName, func(*inifile.IniFile, *slog.Logger, string, []string) (gomc.Module, error) {
