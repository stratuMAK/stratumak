...
func currentValues() map[string]string {
	return map[string]string{
		...
		"EMC2GomcDir":        config.EMC2GomcDir,
...
const (
	...
	ldflagsPkgVar  = "GOMC_LDFLAGS_PKG"
	ldflagsPkgPath = "github.com/sittner/linuxcnc/src/gomc/internal/config"
)
...
// checking that each one is qualified with GOMC_LDFLAGS_PKG rather than a
...
// NML-era leftover that gomc does not use.)
