...
sc.write(f'  <property name="aleadscrew" type="float" value="{aleadscrew}"/>\n'.encode())
sc.write(f'  <property name="amaxacc" type="float" value="{amaxacc}"/>\n'.encode())
sc.write(f'  <property name="amaxlim" type="float" value="{amaxlim}"/>\n'.encode())
sc.write(f'  <property name="amaxvel" type="float" value="{amaxvel}"/>\n'.encode())
sc.write('  <property name="amicrostep" type="int" value="1"/>\n'.encode())
sc.write(f'  <property name="aminlim" type="float" value="{aminlim}"/>\n'.encode())
...
sc.write(f'  <property name="pin1" type="string" value="{dPins["1"]}"/>\n'.encode())
sc.write(f'  <property name="pin10" type="string" value="{dPins["10"]}"/>\n'.encode())
sc.write(f'  <property name="pin10inv" type="bool" value="{dInvert["10"]}"/>\n'.encode())
sc.write(f'  <property name="pin11" type="string" value="{dPins["11"]}"/>\n'.encode())
sc.write(f'  <property name="pin11inv" type="bool" value="{dInvert["11"]}"/>\n'.encode())
sc.write(f'  <property name="pin12" type="string" value="{dPins["12"]}"/>\n'.encode())
sc.write(f'  <property name="pin12inv" type="bool" value="{dInvert["12"]}"/>\n'.encode())
sc.write(f'  <property name="pin13" type="string" value="{dPins["13"]}"/>\n'.encode())
sc.write(f'  <property name="pin13inv" type="bool" value="{dInvert["13"]}"/>\n'.encode())
sc.write(f'  <property name="pin14" type="string" value="{dPins["14"]}"/>\n'.encode())
sc.write(f'  <property name="pin14inv" type="bool" value="{dInvert["14"]}"/>\n'.encode())
sc.write(f'  <property name="pin15" type="string" value="{dPins["15"]}"/>\n'.encode())
sc.write(f'  <property name="pin15inv" type="bool" value="{dInvert["15"]}"/>\n'.encode())
sc.write(f'  <property name="pin16" type="string" value="{dPins["16"]}"/>\n'.encode())
sc.write(f'  <property name="pin16inv" type="bool" value="{dInvert["16"]}"/>\n'.encode())
sc.write(f'  <property name="pin17" type="string" value="{dPins["17"]}"/>\n'.encode())
sc.write(f'  <property name="pin17inv" type="bool" value="{dInvert["17"]}"/>\n'.encode())
sc.write(f'  <property name="pin1inv" type="bool" value="{dInvert["10"]}"/>\n'.encode())
sc.write(f'  <property name="pin2" type="string" value="{dPins["2"]}"/>\n'.encode())
sc.write(f'  <property name="pin2inv" type="bool" value="{dInvert["2"]}"/>\n'.encode())
sc.write(f'  <property name="pin3" type="string" value="{dPins["3"]}"/>\n'.encode())
sc.write(f'  <property name="pin3inv" type="bool" value="{dInvert["3"]}"/>\n'.encode())
sc.write(f'  <property name="pin4" type="string" value="{dPins["4"]}"/>\n'.encode())
sc.write(f'  <property name="pin4inv" type="bool" value="{dInvert["4"]}"/>\n'.encode())
sc.write(f'  <property name="pin5" type="string" value="{dPins["5"]}"/>\n'.encode())
sc.write(f'  <property name="pin5inv" type="bool" value="{dInvert["5"]}"/>\n'.encode())
sc.write(f'  <property name="pin6" type="string" value="{dPins["6"]}"/>\n'.encode())
sc.write(f'  <property name="pin6inv" type="bool" value="{dInvert["6"]}"/>\n'.encode())
sc.write(f'  <property name="pin7" type="string" value="{dPins["7"]}"/>\n'.encode())
sc.write(f'  <property name="pin7inv" type="bool" value="{dInvert["7"]}"/>\n'.encode())
sc.write(f'  <property name="pin8" type="string" value="{dPins["8"]}"/>\n'.encode())
sc.write(f'  <property name="pin8inv" type="bool" value="{dInvert["8"]}"/>\n'.encode())
sc.write(f'  <property name="pin9" type="string" value="{dPins["9"]}"/>\n'.encode())
sc.write(f'  <property name="pin9inv" type="bool" value="{dInvert["9"]}"/>\n'.encode())
...
sc.write(f'  <property name="units" type="int" value="{units}"/>\n'.encode())
...
sc.write(f'  <property name="xleadscrew" type="float" value="{xleadscrew}"/>\n'.encode())
sc.write(f'  <property name="xmaxacc" type="float" value="{xmaxacc}"/>\n'.encode())
sc.write(f'  <property name="xmaxlim" type="float" value="{xmaxlim}"/>\n'.encode())
sc.write('  <property name="xmaxvel" type="float" value="1.0"/>\n'.encode())
sc.write('  <property name="xmicrostep" type="float" value="1.0"/>\n'.encode())
sc.write(f'  <property name="xminlim" type="float" value="{xminlim}"/>\n'.encode())
...
sc.write(f'  <property name="yleadscrew" type="float" value="{xleadscrew}"/>\n'.encode())
sc.write(f'  <property name="ymaxacc" type="float" value="{ymaxacc}"/>\n'.encode())
sc.write(f'  <property name="ymaxlim" type="float" value="{ymaxlim}"/>\n'.encode())
sc.write('  <property name="ymaxvel" type="float" value="1.0"/>\n'.encode())
sc.write('  <property name="ymicrostep" type="float" value="1.0"/>\n'.encode())
sc.write(f'  <property name="yminlim" type="float" value="{yminlim}"/>\n'.encode())
...
sc.write(f'  <property name="zleadscrew" type="float" value="{zleadscrew}"/>\n'.encode())
sc.write(f'  <property name="zmaxacc" type="float" value="{zmaxacc}"/>\n'.encode())
sc.write(f'  <property name="zmaxlim" type="float" value="{zmaxlim}"/>\n'.encode())
sc.write('  <property name="zmaxvel" type="float" value="1.0"/>\n'.encode())
sc.write('  <property name="zmicrostep" type="float" value="1.0"/>\n'.encode())
sc.write(f'  <property name="zminlim" type="float" value="{xminlim}"/>\n'.encode())
...
rm.write('Go through each screen and check for correctness then save when done.'.encode())
rm.close()
