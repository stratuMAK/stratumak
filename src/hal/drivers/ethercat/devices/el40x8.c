...
static const lcec_pindesc_t slave_pins[] = {
  { STMAK_HAL_FLOAT, STMAK_HAL_IO, offsetof(lcec_el40x8_chan_t, scale), "%s.%s.%s.aout-%d-scale" },
  { STMAK_HAL_FLOAT, STMAK_HAL_IO, offsetof(lcec_el40x8_chan_t, offset), "%s.%s.%s.aout-%d-offset" },
  { STMAK_HAL_FLOAT, STMAK_HAL_IO, offsetof(lcec_el40x8_chan_t, min_dc), "%s.%s.%s.aout-%d-min-dc" },
  { STMAK_HAL_FLOAT, STMAK_HAL_IO, offsetof(lcec_el40x8_chan_t, max_dc), "%s.%s.%s.aout-%d-max-dc" },
  { STMAK_HAL_FLOAT, STMAK_HAL_OUT, offsetof(lcec_el40x8_chan_t, curr_dc), "%s.%s.%s.aout-%d-curr-dc" },
  { STMAK_HAL_BIT, STMAK_HAL_IN, offsetof(lcec_el40x8_chan_t, enable), "%s.%s.%s.aout-%d-enable" },
  { STMAK_HAL_BIT, STMAK_HAL_IN, offsetof(lcec_el40x8_chan_t, absmode), "%s.%s.%s.aout-%d-absmode" },
  { STMAK_HAL_FLOAT, STMAK_HAL_IN, offsetof(lcec_el40x8_chan_t, value), "%s.%s.%s.aout-%d-value" },
  { STMAK_HAL_S32, STMAK_HAL_OUT, offsetof(lcec_el40x8_chan_t, raw_val), "%s.%s.%s.aout-%d-raw" },
  { STMAK_HAL_BIT, STMAK_HAL_OUT, offsetof(lcec_el40x8_chan_t, pos), "%s.%s.%s.aout-%d-pos" },
  { STMAK_HAL_BIT, STMAK_HAL_OUT, offsetof(lcec_el40x8_chan_t, neg), "%s.%s.%s.aout-%d-neg" },
...
void lcec_el40x8_write(struct lcec_slave *slave, long period) STMAK_NONBLOCKING;
