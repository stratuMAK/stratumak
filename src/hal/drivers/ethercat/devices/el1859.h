 ...
 *   - `<pfx>.din-<n>`        (STMAK_HAL_BIT, STMAK_HAL_OUT): Digital input state.
 *   - `<pfx>.din-<n>-not`    (STMAK_HAL_BIT, STMAK_HAL_OUT): Inverted digital input state.
 *   - `<pfx>.dout-<n>`       (STMAK_HAL_BIT, STMAK_HAL_IN):  Digital output command.
 *   - `<pfx>.dout-<n>-invert`(STMAK_HAL_BIT, STMAK_HAL_RW param): Invert output polarity when set.
 *
