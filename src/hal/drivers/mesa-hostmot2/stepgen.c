...
void hm2_stepgen_process_tram_read(hostmot2_t *hm2, long l_period_ns) STMAK_NONBLOCKING {
    (void)l_period_ns;
    int i;
    uint32_t mode = 0;
    uint32_t latch = 0;
...
static void hm2_stepgen_instance_prepare_tram_write(hostmot2_t *hm2, long l_period_ns, int i) {
    ...
    *s->hal.pin.velocity_fb = (stmak_hal_float_t)new_vel;
...
void hm2_stepgen_prepare_tram_write(hostmot2_t *hm2, long l_period_ns) STMAK_NONBLOCKING {
    int i;
    for (i = 0; i < hm2->stepgen.num_instances; i ++) {
...
static void hm2_stepgen_update_mode(hostmot2_t *hm2, int i) STMAK_NONBLOCKING {
    uint32_t buff;
    uint32_t modebuff;
    int j;
...
static void hm2_stepgen_set_dpll_timer(hostmot2_t *hm2) STMAK_NONBLOCKING {
    uint32_t data = 0;
...
void hm2_stepgen_write(hostmot2_t *hm2) STMAK_NONBLOCKING {
    int i;
...
static void hm2_stepgen_force_write_dir_setup_time(hostmot2_t *hm2) STMAK_NONBLOCKING {
    int i;
    for (i = 0; i < hm2->stepgen.num_instances; i ++) {
        hm2_stepgen_update_dir_setup_time(hm2, i);
    }
...
static void hm2_stepgen_force_write_dir_hold_time(hostmot2_t *hm2) STMAK_NONBLOCKING {
    int i;
    for (i = 0; i < hm2->stepgen.num_instances; i ++) {
        hm2_stepgen_update_dir_hold_time(hm2, i);
    }
...
static void hm2_stepgen_force_write_pulse_idle_width(hostmot2_t *hm2) STMAK_NONBLOCKING {
    int i;
    for (i = 0; i < hm2->stepgen.num_instances; i ++) {
        hm2_stepgen_update_pulse_idle_width(hm2, i);
    }
...
static void hm2_stepgen_force_write_pulse_width_time(hostmot2_t *hm2) STMAK_NONBLOCKING {
    int i;
    for (i = 0; i < hm2->stepgen.num_instances; i ++) {
        hm2_stepgen_update_pulse_width(hm2, i);
    }
...
static void hm2_stepgen_force_write_master_dds(hostmot2_t *hm2) STMAK_NONBLOCKING {
...
void hm2_stepgen_force_write(hostmot2_t *hm2) STMAK_NONBLOCKING {
...
//    }
...

    {
        ...
        if (hm2->dpll_module_present) {
            ...
            r = stmak_hal_pin_s32_newf(hm2->llio->hal, STMAK_HAL_IN, &(hm2->stepgen.hal->pin.dpll_timer_num), hm2->llio->comp_id, "%s", name);
            if (r < 0) {
        ...
        for (i = 0; i < hm2->stepgen.num_instances; i ++) {
            ...
            r = stmak_hal_pin_float_newf(hm2->llio->hal, STMAK_HAL_IN, &(hm2->stepgen.instance[i].hal.pin.position_cmd), hm2->llio->comp_id, "%s", name);
            if (r < 0) {
            ...
            r = stmak_hal_pin_float_newf(hm2->llio->hal, STMAK_HAL_IN, &(hm2->stepgen.instance[i].hal.pin.velocity_cmd), hm2->llio->comp_id, "%s", name);
            if (r < 0) {
                HM2_ERR("error adding pin '%s', aborting\n", name);
                r = -ENOMEM;
                goto fail5;
            ...
            r = stmak_hal_pin_float_newf(hm2->llio->hal, STMAK_HAL_OUT, &(hm2->stepgen.instance[i].hal.pin.velocity_fb), hm2->llio->comp_id, "%s", name);
            if (r < 0) {
                HM2_ERR("error adding pin '%s', aborting\n", name);
                r = -ENOMEM;
                goto fail5;
            ...
            r = stmak_hal_pin_float_newf(hm2->llio->hal, STMAK_HAL_OUT, &(hm2->stepgen.instance[i].hal.pin.position_fb), hm2->llio->comp_id, "%s", name);
            if (r < 0) {
                HM2_ERR("error adding pin '%s', aborting\n", name);
                r = -ENOMEM;
                goto fail5;
            ...
            r = stmak_hal_pin_s32_newf(hm2->llio->hal, STMAK_HAL_OUT, &(hm2->stepgen.instance[i].hal.pin.counts), hm2->llio->comp_id, "%s", name);
            if (r < 0) {
                HM2_ERR("error adding pin '%s', aborting\n", name);
                r = -ENOMEM;
                goto fail5;
            ...
            r = stmak_hal_pin_bit_newf(hm2->llio->hal, STMAK_HAL_IN, &(hm2->stepgen.instance[i].hal.pin.enable), hm2->llio->comp_id, "%s", name);
            if (r < 0) {
                HM2_ERR("error adding pin '%s', aborting\n", name);
                r = -ENOMEM;
                goto fail5;
            ...
            r = stmak_hal_pin_bit_newf(hm2->llio->hal, STMAK_HAL_IN, &(hm2->stepgen.instance[i].hal.pin.control_type), hm2->llio->comp_id, "%s", name);
            if (r < 0) {
                HM2_ERR("error adding pin '%s', aborting\n", name);
                r = -ENOMEM;
                goto fail5;
            ...
            r = stmak_hal_pin_bit_newf(hm2->llio->hal, STMAK_HAL_IN, &(hm2->stepgen.instance[i].hal.pin.position_reset), hm2->llio->comp_id, "%s", name);
            if (r < 0) {
                HM2_ERR("error adding pin '%s', aborting\n", name);
                r = -ENOMEM;
                goto fail5;
            ...
            if (hm2->stepgen.firmware_supports_index) {
                ...
                r = stmak_hal_pin_float_newf(hm2->llio->hal, STMAK_HAL_OUT, &(hm2->stepgen.instance[i].hal.pin.position_latch), hm2->llio->comp_id, "%s", name);
                if (r < 0) {
                    HM2_ERR("error adding pin '%s', aborting\n", name);
                    r = -ENOMEM;
                    goto fail5;
                ...
                r = stmak_hal_pin_bit_newf(hm2->llio->hal, STMAK_HAL_IO, &(hm2->stepgen.instance[i].hal.pin.index_enable), hm2->llio->comp_id, "%s", name);
                if (r < 0) {
                    HM2_ERR("error adding pin '%s', aborting\n", name);
                    r = -ENOMEM;
                    goto fail5;
               ...
               snprintf(name, sizeof(name), "%s.stepgen.%02d.probe-enable", hm2->llio->name, i);
                r = stmak_hal_pin_bit_newf(hm2->llio->hal, STMAK_HAL_IO, &(hm2->stepgen.instance[i].hal.pin.latch_enable), hm2->llio->comp_id, "%s", name);
                if (r < 0) {
                    HM2_ERR("error adding pin '%s', aborting\n", name);
                    r = -ENOMEM;
                    goto fail5;
                ...
                r = stmak_hal_pin_bit_newf(hm2->llio->hal, STMAK_HAL_IN, &(hm2->stepgen.instance[i].hal.pin.index_polarity), hm2->llio->comp_id, "%s", name);
                if (r < 0) {
                    HM2_ERR("error adding pin '%s', aborting\n", name);
                    r = -ENOMEM;
                    goto fail5;
               ...
               snprintf(name, sizeof(name), "%s.stepgen.%02d.probe-invert", hm2->llio->name, i);
                r = stmak_hal_pin_bit_newf(hm2->llio->hal, STMAK_HAL_IN, &(hm2->stepgen.instance[i].hal.pin.latch_polarity), hm2->llio->comp_id, "%s", name);
                if (r < 0) {
                    HM2_ERR("error adding pin '%s', aborting\n", name);
                    r = -ENOMEM;
                    goto fail5;
            ...
            r = stmak_hal_pin_float_newf(hm2->llio->hal, STMAK_HAL_OUT, &(hm2->stepgen.instance[i].hal.pin.dbg_pos_minus_prev_cmd), hm2->llio->comp_id, "%s", name);
            if (r < 0) {
                HM2_ERR("error adding pin '%s', aborting\n", name);
                r = -ENOMEM;
                goto fail5;
            ...
            r = stmak_hal_pin_float_newf(hm2->llio->hal, STMAK_HAL_OUT, &(hm2->stepgen.instance[i].hal.pin.dbg_ff_vel), hm2->llio->comp_id, "%s", name);
            if (r < 0) {
                HM2_ERR("error adding pin '%s', aborting\n", name);
                r = -ENOMEM;
                goto fail5;
            ...
            r = stmak_hal_pin_float_newf(hm2->llio->hal, STMAK_HAL_OUT, &(hm2->stepgen.instance[i].hal.pin.dbg_s_to_match), hm2->llio->comp_id, "%s", name);
            if (r < 0) {
                HM2_ERR("error adding pin '%s', aborting\n", name);
                r = -ENOMEM;
                goto fail5;
            ...
            r = stmak_hal_pin_float_newf(hm2->llio->hal, STMAK_HAL_OUT, &(hm2->stepgen.instance[i].hal.pin.dbg_vel_error), hm2->llio->comp_id, "%s", name);
            if (r < 0) {
                HM2_ERR("error adding pin '%s', aborting\n", name);
                r = -ENOMEM;
                goto fail5;
            ...
            r = stmak_hal_pin_float_newf(hm2->llio->hal, STMAK_HAL_OUT, &(hm2->stepgen.instance[i].hal.pin.dbg_err_at_match), hm2->llio->comp_id, "%s", name);
            if (r < 0) {
                HM2_ERR("error adding pin '%s', aborting\n", name);
                r = -ENOMEM;
                goto fail5;
            ...
            r = stmak_hal_pin_s32_newf(hm2->llio->hal, STMAK_HAL_OUT, &(hm2->stepgen.instance[i].hal.pin.dbg_step_rate), hm2->llio->comp_id, "%s", name);
            if (r < 0) {
                HM2_ERR("error adding pin '%s', aborting\n", name);
                r = -ENOMEM;
                goto fail5;
            ...
            r = stmak_hal_param_float_newf(hm2->llio->hal, STMAK_HAL_RW, &(hm2->stepgen.instance[i].hal.param.position_scale), hm2->llio->comp_id, "%s", name);
            if (r < 0) {
            ...
            r = stmak_hal_param_float_newf(hm2->llio->hal, STMAK_HAL_RW, &(hm2->stepgen.instance[i].hal.param.maxvel), hm2->llio->comp_id, "%s", name);
            if (r < 0) {
                HM2_ERR("error adding param '%s', aborting\n", name);
                r = -ENOMEM;
                goto fail5;
            ...
            r = stmak_hal_param_float_newf(hm2->llio->hal, STMAK_HAL_RW, &(hm2->stepgen.instance[i].hal.param.maxaccel), hm2->llio->comp_id, "%s", name);
            if (r < 0) {
                HM2_ERR("error adding param '%s', aborting\n", name);
                r = -ENOMEM;
                goto fail5;
            ...
            r = stmak_hal_param_u32_newf(hm2->llio->hal, STMAK_HAL_RW, &(hm2->stepgen.instance[i].hal.param.steplen), hm2->llio->comp_id, "%s", name);
            if (r < 0) {
                HM2_ERR("error adding param '%s', aborting\n", name);
                r = -ENOMEM;
                goto fail5;
            ...
            r = stmak_hal_param_u32_newf(hm2->llio->hal, STMAK_HAL_RW, &(hm2->stepgen.instance[i].hal.param.stepspace), hm2->llio->comp_id, "%s", name);
            if (r < 0) {
                HM2_ERR("error adding param '%s', aborting\n", name);
                r = -ENOMEM;
                goto fail5;
            ...
            r = stmak_hal_param_u32_newf(hm2->llio->hal, STMAK_HAL_RW, &(hm2->stepgen.instance[i].hal.param.dirsetup), hm2->llio->comp_id, "%s", name);
            if (r < 0) {
                HM2_ERR("error adding param '%s', aborting\n", name);
                r = -ENOMEM;
                goto fail5;
            ...
            r = stmak_hal_param_u32_newf(hm2->llio->hal, STMAK_HAL_RW, &(hm2->stepgen.instance[i].hal.param.dirhold), hm2->llio->comp_id, "%s", name);
            if (r < 0) {
                HM2_ERR("error adding param '%s', aborting\n", name);
                r = -ENOMEM;
                goto fail5;
            ...
            r = stmak_hal_param_u32_newf(hm2->llio->hal, STMAK_HAL_RW, &(hm2->stepgen.instance[i].hal.param.step_type), hm2->llio->comp_id, "%s", name);
            if (r < 0) {
                HM2_ERR("error adding param '%s', aborting\n", name);
                r = -ENOMEM;
                goto fail5;
            ...
            if (hm2->stepgen.firmware_supports_swap) {
                ...
                r = stmak_hal_param_bit_newf(hm2->llio->hal, STMAK_HAL_RW, &(hm2->stepgen.instance[i].hal.param.swap_step_dir), hm2->llio->comp_id, "%s", name);
                if (r < 0) {
                    HM2_ERR("error adding param '%s', aborting\n", name);
                    r = -ENOMEM;
                    goto fail5;
            ...
            if (hm2->stepgen.instance[i].table_width > 2){
                ...
                r = stmak_hal_param_u32_newf(hm2->llio->hal, STMAK_HAL_RW, &(hm2->stepgen.instance[i].hal.param.table[0]), hm2->llio->comp_id, "%s", name);
                if (r < 0) {
                    HM2_ERR("error adding param '%s', aborting\n", name);
                    r = -ENOMEM;
                    goto fail5;
                ...
                r = stmak_hal_param_u32_newf(hm2->llio->hal, STMAK_HAL_RW, &(hm2->stepgen.instance[i].hal.param.table[1]), hm2->llio->comp_id, "%s", name);
                if (r < 0) {
                    HM2_ERR("error adding param '%s', aborting\n", name);
                    r = -ENOMEM;
                    goto fail5;
                ...
                r = stmak_hal_param_u32_newf(hm2->llio->hal, STMAK_HAL_RW, &(hm2->stepgen.instance[i].hal.param.table[2]), hm2->llio->comp_id, "%s", name);
                if (r < 0) {
                    HM2_ERR("error adding param '%s', aborting\n", name);
                    r = -ENOMEM;
                    goto fail5;
                ...
                r = stmak_hal_param_u32_newf(hm2->llio->hal, STMAK_HAL_RW, &(hm2->stepgen.instance[i].hal.param.table[3]), hm2->llio->comp_id, "%s", name);
                if (r < 0) {
                    HM2_ERR("error adding param '%s', aborting\n", name);
                    r = -ENOMEM;
                    goto fail5;
...
void hm2_stepgen_print_module(hostmot2_t *hm2) STMAK_NONBLOCKING {
    int i;
    if (hm2->stepgen.num_instances <= 0) return;
