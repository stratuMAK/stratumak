...
//
// // Log ring
// static stmak_log_ring_t *test_ring = NULL;
// static stmak_log_t       stub_log;
//
// static void init_stub_log(void) {
//     if (!test_ring) {
//         test_ring = stmak_ring_create();
...
import (
	...
	_ "github.com/stratuMAK/stratumak/src/stmak/generated/gmi/kins" // registers KinsMeta via init()
