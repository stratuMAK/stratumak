...
func init() {
	stmak.RegisterModule("classicladder", newClassicLadder)
}

// classicladder implements stmak.Module.
...
func newClassicLadder(ini *inifile.IniFile, logger *slog.Logger, name string, args []string) (stmak.Module, error) {
