...
// The three iniX helpers back the //export'ed stmak_ini_* callbacks, where a
...
func TestIniHelpers_NoIni(t *testing.T) {
	...
	// stmak_ini_source_file keeps its "always a valid string" contract (C
...
// resolveConfigPath backs the //export'ed stmak_path_resolve callback, which C
...
func TestResolveConfigPath(t *testing.T) {
	...
	// STMAK_PATH_WRITE — the target need not exist yet.
