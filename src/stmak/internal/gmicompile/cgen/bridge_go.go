...
func (g *bridgeGoGen) emitPreamble() {
	...
	g.printf("// Code generated by modcompile gmi --server-go - DO NOT EDIT.\n")
	EmitMeta(g.w, g.api, "//")
	g.printf("\n")
	g.printf("package %s\n\n", g.pkg)
	...
	g.printf("\t\"unsafe\"\n")
	g.printf("\n")
	g.printf("\t\"github.com/stratuMAK/stratumak/src/stmak/internal/apiserver\"\n")
	g.printf(")\n\n")
	...
	g.printf("var _ = syscall.EINVAL // suppress unused\n")
	if g.hasWatchFuncs() {
