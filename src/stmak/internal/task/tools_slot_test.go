...
import (
	...
	gmitooltable "github.com/stratuMAK/stratumak/src/stmak/generated/gmi/tooltable"
	...
	_ "github.com/stratuMAK/stratumak/src/stmak/internal/tooltable"
)
...
func newToolsImpl(t *testing.T, random bool) *toolsImpl {
	...
	newTT := stmak.GetFactory("tooltable")
	if newTT == nil {
