...
func init() {
	stmak.RegisterModule("persist_sqlite", newPersistSQLite)
}
...
func newPersistSQLite(ini *inifile.IniFile, logger *slog.Logger, name string, args []string) (stmak.Module, error) {
	dbDir := ""
