...
in file the src/cnc/rs274ngc/interp_array.cc .]  are volatile.
...
src/cnc/rs274ngc/interp_internal.hh). This number of numerical
...
'TOLERANCE_EQUAL' in src/cnc/rs274ngc/interp_internal.hh).
