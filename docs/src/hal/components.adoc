...
| link:../man/man9/halui.9.html[halui]             |Observe HAL pins and command the machine                ||
...
| link:../man/man9/iocontrol.9.html[iocontrol] |Interacts with HAL or G-code in non-realtime                               ||
...
| link:../man/man9/milltask.9.html[milltask]   |Non-realtime task controller for LinuxCNC                                  ||
|===
...
| link:../man/man1/modcompile.1.html[modcompile] |Build, compile and install LinuxCNC HAL components ||
