...
* The package is called "linuxcnc-uspace" for preempt-rt kernels.
...
Pick the OS from the list then pick the major version you want like 2.9-uspace for preempt-rt.
