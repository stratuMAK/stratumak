...
* Example: `[DISPLAY]PROGRAM_PREFIX = /home/myname/stratumak/nc_files`
* Example: `[DISPLAY]PROGRAM_PREFIX = ~/stratumak/nc_files`
...
In the following example, files in /home/myname/stratumak/mysubs will be found before files in ../../nc_files/ngcgui_lib.

.Adding User Directory Example:
[source,{ini}]
----
[RS274NGC]SUBROUTINE_PATH = /home/myname/stratumak/mysubs:../../nc_files/ngcgui_lib:../../nc_files/ngcgui_lib/utilitysubs`
----
