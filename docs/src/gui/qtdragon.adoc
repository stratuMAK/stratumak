...
----
[RS274NGC]
SUBROUTINE_PATH = :~/stratumak/nc_files/examples/ngcgui_lib:~/stratumak/nc_files/examples/ngcgui_lib/utilitysubs; \
~/stratumak/nc_files/examples/probe/basic_probe/macros:~/stratumak/nc_files/examples/remap-subroutines: \
~/stratumak/nc_files/examples/ngcgui_lib/remap_lib
----
...
NGCGUI_SUBFILE_PATH = ~/stratumak/nc_files/examples/ngcgui_lib
...
QtDragon emulates the manualtoolchange HAL pins - don't load the separate HAL component 'manualtoolchange'.

[source,{hal}]
----
net tool-change      manualtoolchange.change   <=  iocontrol.0.tool-change
net tool-changed     manualtoolchange.changed  <=  iocontrol.0.tool-changed
net tool-prep-number manualtoolchange.number   <=  iocontrol.0.tool-prep-number
----
...
SUBROUTINE_PATH = ~/stratumak/nc_files/remap-subroutines:\
~/stratumak/nc_files/remap_lib
...
PATH_APPEND = ~/stratumak/nc_files/remap_lib/python-stdglue/python
# path to the tremap's 'toplevel file
TOPLEVEL = ~/stratumak/nc_files/remap_lib/python-stdglue/python/toplevel.py
----
