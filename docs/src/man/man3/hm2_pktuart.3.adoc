...
The **hm2_modbus** driver (src/hal/drivers/mesa-hostmot2/hm2_modbus.c) is a better example, but significantly more complex and less instructive because of that.
