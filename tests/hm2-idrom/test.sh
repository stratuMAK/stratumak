...
# stmak port: hm2_test is a userspace cmod that logs IDROM validation errors to
# stmakd's stderr (not the kernel dmesg), and stmak's one-shot halrun does
...
# for the expected message.  stmak logs the message body without the classic
